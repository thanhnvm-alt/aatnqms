    ...
    return (
        <div className="flex flex-col h-full bg-slate-50 dark:bg-slate-800/50">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
                        ...
                        <div className="relative w-full md:w-96">
                            ...
                            <input 
                                ...
                                className="w-full pl-12 pr-4 py-4 bg-slate-100 dark:bg-slate-800 border-none rounded-3xl text-sm font-bold text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-blue-600/20 transition-all placeholder:text-slate-400 dark:text-slate-500"
                            />
                        </div>
                    </div>
                </div>
                                        ...
                                        <tr className="bg-slate-50 dark:bg-slate-800/50/80 border-b border-slate-200 dark:border-slate-700">
                                            <th className="px-6 py-5 w-10">
                                                <button onClick={toggleSelectAll} className="p-1 text-slate-400 dark:text-slate-500 hover:text-blue-600 dark:text-blue-400 transition-colors">
                                                    {selectedIds.length === filteredItems.length ? <CheckSquare className="w-5 h-5 text-blue-600 dark:text-blue-400" /> : <Square className="w-5 h-5" />}
                                                </button>
                                            </th>
                                            <th className="px-6 py-5 text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.2em]">Thông tin phiếu</th>
                                            <th className="px-6 py-5 text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.2em]">Dự án / Nội dung</th>
                                            <th className="px-6 py-5 text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.2em]">Người lập / Thời gian xóa</th>
                                            <th className="px-6 py-5 text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.2em] text-right text-red-500 dark:text-red-400">Hành động</th>
                                        </tr>
                                    </thead>
                                            ...
                                            <tr key={item.id} className={`hover:bg-slate-50 dark:hover:bg-slate-800/50 dark:bg-slate-800/50 transition-colors group cursor-pointer ${selectedIds.includes(item.id) ? 'bg-blue-50 dark:bg-slate-800/80/30' : ''}`} onClick={() => handleReview(item.id)}>
                                                <td className="px-6 py-5" onClick={e => e.stopPropagation()}>
                                                    <button onClick={() => toggleSelect(item.id)} className="p-1 text-slate-400 dark:text-slate-500 hover:text-blue-600 dark:text-blue-400 transition-colors">
                                                        {selectedIds.includes(item.id) ? <CheckSquare className="w-5 h-5 text-blue-600 dark:text-blue-400" /> : <Square className="w-5 h-5" />}
                                                    </button>
                                                </td>
                                                <td className="px-6 py-5">
                                                    <div className="flex flex-col gap-1">
                                                        <div className="flex items-center gap-2">
                                                            <span className="font-black text-slate-900 dark:text-slate-100 text-sm tracking-tight">{item.id}</span>
                                                            <Eye className="w-3.5 h-3.5 text-slate-300 group-hover:text-blue-500 dark:text-blue-400 transition-colors" />
                                                        </div>
                                                        <span className="inline-flex px-2 py-0.5 bg-blue-50 dark:bg-slate-800/80 text-blue-600 dark:text-blue-400 rounded-lg text-[9px] font-black w-fit uppercase">
                                                ...
                                                <td className="px-6 py-5">
                                                    <div className="flex flex-col gap-0.5">
                                                        <p className="text-sm font-black text-slate-800 dark:text-slate-200 line-clamp-1 truncate uppercase">{item.ten_ct || 'N/A'}</p>
                                                        <p className="text-[10px] font-bold text-slate-400 dark:text-slate-500 truncate max-w-[200px]">{item.ten_hang_muc || 'N/A'}</p>
                                                    </div>
                                                </td>
                                                <td className="px-6 py-5">
                                                    <div className="flex flex-col gap-0.5">
            ...
            <footer className="p-6 bg-white dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800">
                <div className="max-w-7xl mx-auto flex items-center justify-between text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest italic">
